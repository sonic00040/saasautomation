      ...
      <Card className="w-full max-w-md relative z-10 shadow-xl border-0 bg-white/80 backdrop-blur-md">
        <CardHeader className="text-center pb-2">
          ...
          <CardDescription className="text-gray-600 mt-2">
            Join BotAI and start building intelligent chatbots today
          </CardDescription>
        </CardHeader>
          ...
          <CardContent className="space-y-6 pt-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                />
                <svg className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.25-2a9 9 0 01-3.25 6.75L21 21l-3.25-3.25A9 9 0 019 12z" />
                </svg>
              </div>
            </div>
          </CardContent>
